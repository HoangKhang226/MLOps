...
class DataTransformation:
    ...
    def smote_oversampling(self, df, target_column):
        ...
        logger.info(f"SMOTE applied. New distribution: {y_res.value_counts().to_dict()}")
        return df_balanced
    ...
    def initiate_data_transformation(self):
        try:
            ...
            df = self.bin_col(df, ["Partner", "Dependents", "PhoneService", "PaperlessBilling", "Churn"])
            ...
            if 'TotalCharges' in df.columns:
                ...
                df = self.fill_null(df, 'TotalCharges', strategy='constant', fill_value=0)
